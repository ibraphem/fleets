            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                  <!--  <nav class="multineed navbar navbar-default menu-export" role="navigation">
                    ...
                    <div class="panel-heading" style="padding-top: 6px;">{{trans('Report')}} - {{trans('General Report')}}</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label >{{__('From')}}</label>
                                    <input type="text" name="StartDate" id="gStartDate" class="form-control" required />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="EndDate">{{__('To')}}</label>
                                    <input type="text" name="EndDate" id="gEndDate" class="form-control" required />
                                </div>
                            </div>
                        </div>

                        <div id="list-general-report"></div>
                    </div>
                </div>
            </div>
        </div>
