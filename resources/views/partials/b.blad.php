...
<aside class="main-sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
      ...
      @endif
      @if(auth()->user())
      <li class="{{(Request::is('vehicles')) ? 'active' : ''}} "><a href="{{ url('/vehicles') }}"><i class="fa fa-bars"></i> <span>Vehicles</span></a></li>
      @endif
      @if(auth()->user())
      <li class="{{(Request::is('vehicleusers')) ? 'active' : ''}} "><a href="{{ url('/vehicleusers') }}"><i class="fa fa-bars"></i> <span>Vehicle Users</span></a></li>
      @endif
      @if(auth()->user())
      <li class="{{(Request::is('assignments')) ? 'active' : ''}} "><a href="{{ url('/assignment') }}"><i class="fa fa-bars"></i> <span>Veh. Assignment</span></a></li>
      @endif
      @if(auth()->user())
      <li class="treeview">
          <a href="#"><i class="fa fa-university"></i> <span>{{trans('Maintenance')}}</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
